...
<body>
	<div class = "container">
		...
		if (isset($_SESSION['id'])) {
			...
			echo "<br>";
			echo "<br>";
			echo "<header><h1 class = 'message'>Test Created Successfully!</h1></header>";
			echo "<div class = 'boxy' style = 'height: 100px'><a href = 'home.php'><h3 style = 'line-height: 100px; font-size: 40px; text-align: center;'>Return Home</h3></a></div>";
			echo "<br>";
			echo "<br>";
